...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__tstwam

#else
#  define SWIG_init    init_tstwam

#endif
#define SWIG_name    "_tstwam"
...
SWIGINTERN PyObject *_wrap_search(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:search",&obj0)) SWIG_fail;
  res1 = SWIG_AsArgcArgv(obj0, SWIGTYPE_p_p_char, &argc1, &argv1, &owner1);
  if (!SWIG_IsOK(res1)) {
    arg1 = 0; arg2 = 0;
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "search" "', argument " "1"" of type '" "int ARGC, char **ARGV""'");
  } else {
    arg1 = (int)(argc1);
    arg2 = (char **)(argv1);
  }
  result = (int)search(arg1,arg2);
